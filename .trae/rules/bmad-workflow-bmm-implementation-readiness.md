# implementation-readiness Workflow Rule

This rule defines the implementation-readiness workflow.
...
Reference this workflow with `@workflow-implementation-readiness` to execute the guided workflow.
